...
func (t Training) meanSpeed() float64 {
	if t.Duration == 0 {
		return 0 // если длительность равна 0, то средняя скорость также 0
	}
...
func (t Training) Calories() float64 {
	return 0 // метод будет переопределяться в дочерних структурах
}
...
// TrainingInfo возвращает структуру InfoMessage для бега.
...
// Константы для расчета потраченных калорий при плавании.
const (
